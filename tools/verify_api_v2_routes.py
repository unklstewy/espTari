...
EXPECTED_ROUTES = {
    ...
    ("GET", "/api/v2/conformance/harness/checklist/run/status"),
    ...
    ("GET", "/api/v2/conformance/subsystems/fixtures/model"),
    ("POST", "/api/v2/conformance/subsystems/suites/run"),
    ("GET", "/api/v2/conformance/subsystems/suites/report"),
...
def main() -> int:
    ...
    required_registrars = {
        ...
        "esptari_web_conformance_register_routes",
