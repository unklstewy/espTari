...
## S5 runtime unlock tasks

| ID | Epic | Task | Priority | Size | Sprint Target | Status | Dependencies |
|---|---|---|---|---|---|---|---|
| S5-001 | EPIC-06 | Define EBIN runtime ABI baseline and compatibility contract | P0 | S | S5 | Done | PRQ-004 |
| S5-002 | EPIC-06 | Implement EBIN manifest/schema validator with deterministic error mapping | P0 | S | S5 | Done | S5-001 |
| S5-003 | EPIC-06 | Implement ordered EBIN load safety gates (integrity/signature/dependency) | P0 | S | S5 | Done | S5-002 |
| S5-004 | EPIC-06 | Implement EBIN resolver for machine/component/version selection | P0 | S | S5 | Done | S5-001 |
| S5-005 | EPIC-06 | Implement runtime EBIN load/unload orchestration hooks | P0 | S | S5 | Done | S5-003, S5-004 |
| S5-006 | EPIC-06 | Implement rollback/fallback and activation-fault telemetry | P0 | S | S5 | Done | S5-005 |
| S5-007 | EPIC-06 | Deliver end-to-end runtime unlock harness and reference package artifacts | P0 | S | S5 | Done | S5-005, S5-006 |
| S5-008 | EPIC-06 | Assemble S5 unlock decision packet and traceability handoff | P0 | XS | S5 | Done | S5-007 |
