<!-- NAV_META: doc=D; index=README.md; prev=C_model_delta_summary.md; next=- -->
...
**Purpose:** Define proof requirements to upgrade inferred/revision-specific behavior to verified status.
